...
@Component({
  selector: "app-training-event-table",
  templateUrl: "./training-event-table.component.html",
  styleUrls: ["./training-event-table.component.scss"],
})
export class TrainingEventTableComponent implements OnInit {
  id: string = "";
  type: string = "";
  events: IEvent[] = [];
  order = {
  ...
  ngOnInit(): void {
    ...
    this._route.queryParamMap.subscribe((params) => {
      this.type = params.get("filter");
      this.title =
        this.type === "product" ? "Training Product" : "Training Announcements";
      this.getData();
    });
  }
  ...
  getData() {
    ...
    this._trainingService
      .getTrainingAnnoucement(this.type)
      .subscribe((data) => {
